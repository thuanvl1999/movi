 ...
 */
final class Version20220416194405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD user_id INT NOT NULL, CHANGE releas_year release_year INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD releas_year INT NOT NULL, DROP release_year, DROP user_id');
    }
}
